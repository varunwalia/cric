...
SECRET_KEY = os.environ.get('SECRET_KEY', '-5a627tj!_ywa4el%q5sw9_su+0u=*^lq29w^s!r670gl_*%^g')  
EMAIL_HOST_PASSWORD = os.environ.get('@pbvsW954014')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', '.pythonanywhere.com','cric--pro.herokuapp.com']
